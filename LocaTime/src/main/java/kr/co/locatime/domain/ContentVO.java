...
public class ContentVO {
	...
	public String toString() {
		return "ContentVO [user_id=" + user_id + ", content_able=" + content_able + ", content_SellingPrice="
				+ content_SellingPrice + ", content_OriPrice=" + content_OriPrice + ", content_deadline="
				+ content_deadline + ", content_title=" + content_title + ", content_num=" + content_num
